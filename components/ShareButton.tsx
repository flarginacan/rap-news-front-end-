...
export default function ShareButton({ articleSlug, articleTitle }: ShareButtonProps) {
  ...
  const handleLinkedInShare = () => {
    window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(articleUrl)}`, '_blank', 'width=550,height=420')
  }
          ...
          >
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-3">
                ...
                >
                  <svg className="w-6 h-6 mb-1 text-blue-700" fill="currentColor" viewBox="0 0 24 24">
