...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black w-full h-16 md:h-20 flex items-center justify-center px-4 md:px-8">
      <Link 
        href="/" 
        className="hover:opacity-80 transition-opacity flex items-center justify-center relative z-10 block"
        style={{ pointerEvents: 'auto', textDecoration: 'none' }}
      >
        <h1 className="text-red-600 text-3xl md:text-5xl lg:text-6xl font-black text-center tracking-tight md:tracking-tighter cursor-pointer m-0">
          RAP NEWS
        </h1>
      </Link>
